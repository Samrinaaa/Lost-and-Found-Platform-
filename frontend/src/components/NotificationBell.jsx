...
const styles = {
  ...
  bellIcon: { width: 22, height: 22, objectFit: "contain" },
  badge: {
  ...
  dropdown: {
    ...
    border: "1px solid rgba(45,106,100,0.1)", zIndex: 1000, overflow: "hidden",
  },
  dropdownHeader: {
    display: "flex", justifyContent: "space-between", alignItems: "center",
    padding: "16px 18px 12px", borderBottom: "1px solid rgba(45,106,100,0.08)",
  },
  dropdownTitle: {
    fontFamily: "'Playfair Display', Georgia, serif",
    fontSize: 16, fontWeight: 700, color: "#2c3e3a",
  },
  markAllBtn: {
    fontSize: 12, fontWeight: 600, color: "#2d6a64",
    background: "transparent", border: "none", cursor: "pointer",
    padding: "4px 8px", borderRadius: 6,
  },
  notifList:    { maxHeight: 360, overflowY: "auto" },
  emptyNotif:   { textAlign: "center", padding: "32px 20px", color: "#5a6e6a", fontSize: 13 },
  notifItem: {
    display: "flex", alignItems: "flex-start", gap: 12, padding: "12px 18px",
    cursor: "pointer", transition: "background 0.15s ease",
    borderBottom: "1px solid rgba(45,106,100,0.05)",
  },
  notifIcon:    { fontSize: 18, flexShrink: 0, marginTop: 2 },
  notifBody:    { flex: 1, minWidth: 0 },
  notifMessage: { fontSize: 13, color: "#2c3e3a", lineHeight: 1.5, margin: "0 0 4px", fontWeight: 500 },
  notifTime:    { fontSize: 11, color: "#9ca3af" },
  unreadDot: {
    width: 8, height: 8, borderRadius: "50%",
    background: "#2d6a64", flexShrink: 0, marginTop: 4,
  },
};
