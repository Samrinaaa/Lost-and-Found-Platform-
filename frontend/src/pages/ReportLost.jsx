...
const ReportLost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage("success");
      setFormData({ itemName: "", description: "", locationLost: "", dateLost: "", category: "" });
      setImage(null);
      ...
      <div style={styles.content}>
        ...
        <div style={styles.pageTitle}>
          ...
          <p style={styles.subtitle}>
            Fill in the details below to report a lost item. The more detail you provide, the better the chances of recovery.
          </p>
        </div>
